    ...
    <div className="relative rounded-md">
      <input
        ...
        className={classnames(
          "border-gray-6 placeholder:text-gray-11 focus-visible:ring-blue-6 flex h-10 w-full rounded-md border bg-transparent px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
        ref={ref}
        {...props}
